...
class Clinica(models.Model):
    ...
    def atingiu_limite_narrativas(self):
        # TRAVA DEFINITIVA: Se a assinatura estiver inativa/cancelada, bloqueia imediatamente.
    ...
    def clean(self):
        if not self.pk and self.clinica:
            if self.clinica.atingiu_limite_narrativas():
                raise ValidationError("Sua clínica atingiu o limite do plano ou sua assinatura está inativa.")
