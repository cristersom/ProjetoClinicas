...
class CriarContaView(CreateView):
    ...
    def get_initial(self):
        ...
        # Agora busca o e-mail que veio protegido na URL
    ...
    def form_valid(self, form):
        ...
        # TRAVA DEFINITIVA NO FORMULÁRIO: Mostra erro vermelho embaixo do campo
        if not pagamento:
...
def sucesso_pagamento(request):
    ...
    try:
        ...
        if user:
            ...
            # Envia o email na URL para evitar perda de sessão
