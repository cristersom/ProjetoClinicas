...
class TenantPermissionsMixin:
    ...
    def has_add_permission(self, request):
        ...
        clinica = getattr(request, 'clinica_realtime', None)
        if clinica and not clinica.assinatura_ativa: return False
        return True
    ...
    def has_add_permission(self, request):
        ...
        if clinica:
            if not clinica.assinatura_ativa:
                return False
            # Verifica o limite real do banco de dados para sumir com o botão da UI
